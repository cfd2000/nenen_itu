...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("Tools AutoClaim BitcoinClick_bot ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Telegram : t.me/Kmgtri")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : Isi hati")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Created : Trhy sethia")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"Youtube Channel : Bugsar Chanel".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   ...
   UravxBuCwNMpYWTzKhRA(1)
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPn+"Ingat Termuxnya Jangan di close",end="\n\n")
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   ...
   try:
    ...
    pass
  UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Subscribe To Bugsar chanel :)')
